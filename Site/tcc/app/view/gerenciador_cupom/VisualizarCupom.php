		...
		<div class="fixed-top">
			<div class="collapse" id="navbarToggleExternalContent">
				<div class="bg-dark p-3">
					...
					<a href="Criar Cupom.html"><span class="text-white bg-dark">Criar Cupom</span></a><br><br>
					<a href="VisualizarCupom.php"><span class="text-white bg-dark">Visualizar Cupom</span></a>
				</div>
			</div>
