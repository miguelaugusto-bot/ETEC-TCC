		...
		<div class="fixed-top">
			<div class="collapse" id="navbarToggleExternalContent">
				<div class="bg-dark p-3">
					...
					<a href="gerar.html"><span class="text-white bg-dark">Criar Cupom</span></a><br><br>
		...
		<div class="card col-md-6 .offset-md-3 menuAjuste">
			<div class="card-body">
				...
				<form action="../../lib/php/CRUD_Cupom/inserir.php" method="POST" onsubmit="return false;" id="form">
					Cupom:
					<input name="cupom" autocomplete="off" type="text", id="cupom", class="form-control"><br>
					Data de expiração:
				...
				$arquivo = fopen('arquivo/score.txt', 'w+');
